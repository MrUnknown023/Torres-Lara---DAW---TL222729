function inicializar(){
    ...
    var inicializar, max, temp, contenido = "" , tdelement;
    
    //validación para que el número de elementos del arreglo sea numérico y mayor o igual que 2
    do{
        max = prompt("Cuantos números va a ingresar (valor entero): ", "");
        //Verificar que se ingrese un dato númerico
        if(isNaN(max)){
